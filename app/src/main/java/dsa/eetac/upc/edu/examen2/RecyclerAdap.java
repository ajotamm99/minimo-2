...
public class RecyclerAdap extends RecyclerView.Adapter<RecyclerAdap.ReposViewHolder>{
    private List<Repos> repos;
    private int rowLayout;
    private Context context;

    public RecyclerAdap(List<Repos> repos, int rowLayout, Context context) {
        this.setRepos(repos);
    ...
    public void setRepos(List<Repos> repos) {this.repos = repos;}
    ...
    @Override
    public RecyclerAdap.ReposViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
